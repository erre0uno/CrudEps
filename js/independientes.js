...
saveLocal("Independientes", afiliados);
...
var afiliadosDefault = [
    {tipoId: "CEDULA DE CIUDANIA", numero: 1, paciente: "juan test", ciudad:"MEDELLIN", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "CENTRO"},
    {tipoId: "OTRA", numero: 2, paciente: "pedro test", ciudad:"MEDELLIN", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "NORTE"},
    {tipoId: "CEDULA DE EXTRANJERIA", numero: 3, paciente: "test test", ciudad:"CALI", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "OESTE"},
    {tipoId: "OTRA", numero: 4, paciente: "maria test", ciudad:"CALI", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "SUR"},
    {tipoId: "REGISTRO CIVIL", numero: 5, paciente: "mile test", ciudad:"BARRANQUILLA", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "NORTE"},
    {tipoId: "OTRA", numero: 6, paciente: "juancho test", ciudad:"CALI", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "SUR"},
    {tipoId: "CEDULA DE EXTRANJERIA", numero: 7, paciente: "test test", ciudad:"BOGOTA", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "OESTE"},
    {tipoId: "REGISTRO CIVIL", numero: 8, paciente: "estiven test", ciudad:"BOGOTA", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "CENTRO"},
    {tipoId: "OTRA", numero: 9, paciente: "mauricio test", ciudad:"BOGOTA", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "NORTE"},
    {tipoId: "CEDULA DE CIUDANIA", numero: 10, paciente: "paula test", ciudad:"BARRANQUILLA", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "SUR"},
    {tipoId: "REGISTRO CIVIL", numero: 11, paciente: "diana test", ciudad:"CALI", fecha: "calle 123", correo:"test@test.com", postal:"barrio fake", especialidad: "SUR"},
];
saveLocal("Independientes", afiliadosDefault);
...
function crearAfiliado() {
    ...
    if (tipoId != "" && numero != "" && paciente != "" && fecha != "" && especialidad != "" && ciudad != "" && correo != "" && postal != "" && terminos === "true" ) {
        ...
        if (getLocal("Independientes") === null) {
            let afiliados = [];
            afiliados.push(afiliado);
            saveLocal("Independientes", afiliados);

        } else {
            let afiliados = getLocal("Independientes");
            afiliados.push(afiliado);
            saveLocal("Independientes", afiliados);
        }
        limpiarFormulario()
...
function mostrarAfiliadoId(pid) {
    ...
    if (index != -1) {
        afiliados = getLocal("Independientes");
...
function buscarAfiliado(pid) {
    var afiliados = getLocal("Independientes");
